export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/17Y1LGsE_-_clT-SdoyIm0DF4SuteYafZ/view?usp=sharing",
...
export const experiences = [
  ...
  {
    id: 5,
    img: "http://apps.ituzaingo.dns/assets/brand-8572ae44.png",
    role: "Support IT",
    company: "Municipalidad de Ituzaingó",
    date: "Sep 2023 - Present",
    desc: "Provided exceptional technical support to end-users, troubleshooting and resolving IT issues promptly. Collaborated with cross-functional teams to enhance system performance and optimize user experiences on Neurobit PSG & Hybrid Portals. Successfully diagnosed and fixed bugs, resulting in a 40% reduction in load time. Contributed to the development of the Neurobit Analytics portal using React JS, ensuring seamless interaction with REST APIs through AXIOS. Led the initiative to refactor existing code to TypeScript, updated dependencies, and integrated Vite with Jest for efficient unit testing.",
    skills: [
      "Technical Support",
      "Issue Resolution",
